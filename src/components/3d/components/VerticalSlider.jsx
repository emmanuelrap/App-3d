...
const modelos = [
	...
	{ id: 7, categoria: "Autos", model: "/models/auto1.glb", image: "/avatars/autos1.PNG" },
	{ id: 8, categoria: "Autos", model: "/models/auto2.glb", image: "/avatars/autos2.PNG" },
	{ id: 9, categoria: "Autos", model: "/models/auto3.glb", image: "/avatars/autos3.PNG" },
	{ id: 10, categoria: "Autos", model: "/models/auto4.glb", image: "/avatars/autos4.PNG" },
			...
			<List>
				{modelosFiltrados.map((model) => (
					<ListItem key={model.id} button onClick={() => handleClickModelo(model)} selected={selectedModelo === model.id}>
						<Avatar sx={{ width: 50, height: 50 }} alt={`Avatar ${model.id}`} src={model.image} />
					</ListItem>
				))}
			</List>
		</Box>
